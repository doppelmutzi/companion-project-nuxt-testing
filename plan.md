...
- [x] **12. Custom `error.vue`** — Create `app/error.vue` to display a styled error page (404 and generic) with a "Back to home" `<NuxtLink>`. Replace the default Nuxt error screen.
